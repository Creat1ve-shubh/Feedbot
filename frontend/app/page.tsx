      ...
      <main className="relative min-h-screen w-full bg-[#f5f3f0] flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="min-h-screen w-full bg-[#f5f3f0] flex flex-col items-center justify-center p-6">
          ...
          <div className="relative max-w-6xl w-full flex-1 flex flex-col justify-center">
            ...
            {/* Center framed pixel card with SVG background */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
              {/* SVG Background Layer */}
              <div className="absolute inset-0 w-full h-full rounded-[25px] overflow-hidden pointer-events-none -z-10">
                <svg
                  viewBox="0 0 400 500"
              ...
              {/* PixelCard Overlay - sits on top without children to allow interaction */}
              <PixelCard
                variant="pink"
                className="shadow-[0_20px_40px_rgba(0,0,0,0.35)]"
              />
            </div>
